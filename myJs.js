...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu đẹp trai :<< hí hí ";
    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Mai tớ qua chở cậu đi chơi nhaaaaaaaaaaaaa^-^ Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://www.facebook.com/profile.php?id=100025987950927';
                  }
            })
        }
    })
